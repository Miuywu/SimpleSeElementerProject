...
public final class PageObjectMod {
     ...
     */
    public PageObjectMod(WebDriver context, String jsonFileSource) {
     ...
     * @return - The current {@link PageObjectMod} instance.
     */
    public PageObjectMod forLocale(String locale) {
        this.locale = locale;
        return this;
    }
