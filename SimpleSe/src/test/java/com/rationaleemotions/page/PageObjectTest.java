...
public class PageObjectTest {
    ...
    public void testCheckboxCount() {
        ...
        PageObjectMod checkboxPage = new PageObjectMod(driver, "src/test/resources/CheckboxPage.json");
    ...
    public void testPageWithDifferentLocale() {
        WebDriver driver = new FakeDriver();
        PageObjectMod homePage = new PageObjectMod(driver, "src/test/resources/HomePage.json").forLocale("en_FR");
    ...
    public void testInvalidElement() {
        WebDriver driver = new FakeDriver();
        PageObjectMod homePage = new PageObjectMod(driver, "src/test/resources/HomePage.json");
